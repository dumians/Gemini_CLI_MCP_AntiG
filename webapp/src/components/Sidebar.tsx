...
export const Sidebar = ({ activeView, onViewChange, onOpenSettings }: SidebarProps) => {
  const navItems = [
    ...
    { id: 'analysis', label: 'Query Builder', icon: BarChart3, status: 'online' },
  ];
        ...
        <div className="bg-slate-800/50 rounded-xl p-4">
          ...
          {onOpenSettings && (
            <button 
              ...
              className="w-full py-2 bg-slate-700 text-xs font-medium rounded-lg hover:bg-primary transition-all text-white"
            >
              Settings
            </button>
          )}
