    ...
    return (
        <div className="fixed inset-0 bg-[#050506] flex items-center justify-center p-6 z-50">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-accent/10 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '2s' }} />
            ...
            <div className="w-full max-w-md relative animate-in fade-in zoom-in duration-700">
                <div className="glass-card rounded-[2.5rem] p-10 border-white/5 relative overflow-hidden backdrop-blur-3xl shadow-2xl">
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-primary to-transparent opacity-50" />
                    
                    <div className="flex flex-col items-center text-center mb-10">
                        <div className="w-20 h-20 rounded-3xl bg-primary/20 flex items-center justify-center border border-primary/30 mesh-glow mb-6 group hover:rotate-12 transition-transform duration-500">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-4">
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full h-14 bg-white/[0.03] border border-white/10 rounded-2xl pl-12 pr-4 focus:outline-none focus:border-primary/50 transition-all text-xs font-bold tracking-widest uppercase placeholder:text-white/10"
                                    required
                                />
                            </div>
                        ...
                        <button
                            ...
                            className="w-full h-14 command-gradient rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 relative overflow-hidden group"
                        >
                    ...
                    <div className="mt-10 flex items-center justify-center gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-green-500 mesh-glow animate-pulse" />
