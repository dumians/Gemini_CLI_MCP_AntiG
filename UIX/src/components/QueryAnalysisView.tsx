...
import { RefreshCw, Database, FileText, CheckCircle2, TrendingUp } from 'lucide-react';
    ...
    return (
      <div className="p-8 flex items-center justify-center h-[60vh]">
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-400">Ask the Data Agent a question from the dashboard to see real-time execution analysis.</p>
        </div>
      </div>
    );
  }
              ...
              {queryState?.steps?.map((step: any, i: number) => (
                <div key={i} className="flex gap-4 relative">
                  ...
                  <div className="flex-1">
                    <h4 className="text-base font-bold mb-1 text-slate-900 dark:text-white">
                      {step.agent}
                    </h4>
